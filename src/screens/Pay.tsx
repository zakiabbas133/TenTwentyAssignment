...
import { PaySvg } from "../../assets/svgs/Pay";
            ...
            <View style={[styles.headerContainer, { paddingTop: insets.top }]}>
                ...
                <View style={styles.headerCenter}>
                    ...
                    <Text style={styles.headerSubtitleText}>
                        {route.params.date} | {route.params.time === 1 ? "12" : "14"}:30 Hall 1
                    </Text>
                </View>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.legendContainer}>
                    ...
                    <View style={styles.selectedSeatContainer}>
                        ...
                        <SvgXml xml={PaySvg.cross} style={styles.crossIcon} />
                    </View>
                </View>
                ...
                <View style={[styles.footerContainer, { paddingBottom: insets.bottom }]}>
                    ...
                    <TouchableOpacity
                        onPress={() => navigation.navigate("TenTwentyTabs")}
